...
export default function FacturacionTesoreriaList() {
  ...
  // Clientes (para listar y selects)
  useEffect(() => {
  ...
  const handleCrearComprobante = async () => {
    try {
      const comprobanteConEmpresa = {
        ...nuevoComprobante,
        total: Number(derivedTotal.toFixed(2)), // 👈 total calculado automáticamente
        ...
        <tbody>
          {comprobantes.map((comp) => (
            ...
            >
              ...
              <td>
                {customers.find((c) => c.id === comp.cliente_id)?.nombre ||
                  comp.cliente_id}
              </td>
              <td>
              ...
              <div className="row">
                ...
                <Form.Group className="mb-3 col-md-6">
                  ...
                  <Form.Control
                    ...
                    step="0.01"
                    name="total"
                    value={Number.isFinite(derivedTotalEdit) ? derivedTotalEdit.toFixed(2) : "0.00"}
                    readOnly
                  />
                </Form.Group>
            ...
            <div className="row">
              <Form.Group className="mb-3 col-md-6">
                ...
                <Form.Control
                  ...
                  step="0.01"
                  name="total"
                  value={Number.isFinite(derivedTotal) ? derivedTotal.toFixed(2) : "0.00"}
                  readOnly
                />
              </Form.Group>
