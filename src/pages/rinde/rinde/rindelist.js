...
// import { Container, Table, Button, FormControl } from "react-bootstrap";
// import Contexts from "../../../context/Contexts";
// import "../../../components/css/stylesRinde.css";
...
//       { label: "M.B. estimado del Cerdo", key: "mbcerdo" },
//       { label: "Costo prom. /Kg. De Carne", key: "costoprom" },
//       { label: "Margen de la venta de carne", key: "mgtotal" },
//       { label: "Margen/Kg. Vendido de Carne", key: "mgporkg" },
//       { label: "Promedio de Venta diaria", key: "promdiario" },
//       { label: "Total de Venta", key: "totalventa" },
//       { label: "Gastos Diarios", key: "gastos" },
//       { label: "Gastos Caja Grande", key: "cajagrande" },
//       { label: "Otros productos", key: "otros" },
//       { label: "1/2 Res Ingresada", key: "costovacuno" },
//       { label: "Achuras y Productos", key: "achuras" },
//       { label: "Diferencia de Inventario", key: "difInventario" },
//       { label: "Compra de Cerdo", key: "costoporcino" },
//       { label: "KG. De Cerdo", key: "totalKgCerdo" },
//     ];

//     const columnas = rindes.map((r) => ({
//       titulo: `${r.mes}/${r.anio}`,
//       ...r,
//     }));
...
//   const handleFilter = async () => {
//     if (!searchSucursal || !searchMes || !searchAnio) {
//       alert("Complete mes, año y sucursal para filtrar.");
//       return;
//     }
...
//                         ? parseFloat(col[metrica.key]).toLocaleString("es-AR", {
