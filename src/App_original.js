...
// Auth / Security
import AudioDashboardPage from "./pages/audio/AudioDashboardPage.js";
import AudioSegmentDetailPage from "./pages/audio/AudioSegmentDetailPage.js";
import AudioSegmentsPage from "./pages/audio/AudioSegmentsPage.js";
import BotProductMetaList from "./pages/bot/BotProductMetaList.js";
import BotProductMetaForm from "./pages/bot/BotProductMetaForm.js";
import BotBranchMetaList from "./pages/bot/BotBranchMetaList.js";
import BotBranchMetaForm from "./pages/bot/BotBranchMetaForm.js";
import BotBenefitMetaList from "./pages/bot/BotBenefitMetaList.js";
import BotBenefitMetaForm from "./pages/bot/BotBenefitMetaForm.js";
import BotConversationsPage from "./pages/bot/BotConversationsPage.js";
import BotConversationDetailPage from "./pages/bot/BotConversationDetailPage.js";
...
import PromocionList from "./pages/config/PromocionList";
import PromocionForm from "./pages/config/PromocionForm";

import BotEventMetaList from "./pages/bot/BotEventMetaList.js";
import BotEventMetaForm from "./pages/bot/BotEventMetaForm.js";

import QrLandingPage from "./pages/fidelizacion/public/QrLandingPage";
import RuletaPage from "./pages/fidelizacion/public/RuletaPage";
import RuletaResultadoPage from "./pages/fidelizacion/public/RuletaResultadoPage";
import CuponPublicView from "./pages/fidelizacion/public/CuponPublicView";
import ValidarCupon from "./pages/fidelizacion/admin/ValidarCupon";
import PuntosComercioView from "./pages/fidelizacion/admin/PuntosComercioView";
import ComerciosAsociadosList from "./pages/fidelizacion/admin/ComerciosAsociadosList";
import ComercioAsociadoForm from "./pages/fidelizacion/admin/ComercioAsociadoForm";
import ComercioQrView from "./pages/fidelizacion/admin/ComercioQrView";
import CampaniasList from "./pages/fidelizacion/admin/CampaniasList";
import CampaniaForm from "./pages/fidelizacion/admin/CampaniaForm";
import PremiosClienteList from "./pages/fidelizacion/admin/PremiosClienteList";
import PremioClienteForm from "./pages/fidelizacion/admin/PremioClienteForm";
import DashboardFidelizacion from "./pages/fidelizacion/admin/DashboardFidelizacion";
import ComercioLoginPage from "./pages/fidelizacion/comercio/ComercioLoginPage";
import ComercioDashboard from "./pages/fidelizacion/comercio/ComercioDashboard";
import ComercioPremios from "./pages/fidelizacion/comercio/ComercioPremios";
import ComercioCanjes from "./pages/fidelizacion/comercio/ComercioCanjes";
import PremiosComercioList from "./pages/fidelizacion/admin/PremiosComercioList";
        ...
        <UserContextProvider>
          <DataContext>
            <Routes>
              ...
              <Route path="/qr/:token/participar" element={<RuletaPage />} />
              <Route path="/qr/:token/ruleta" element={<RuletaResultadoPage />} />
              <Route path="/cupon/:token" element={<CuponPublicView />} />

              <Route path="/comercio/login" element={<ComercioLoginPage />} />
              <Route path="/comercio/dashboard" element={<ComercioDashboard />} />
              <Route path="/comercio/premios" element={<ComercioPremios />} />
              <Route path="/comercio/canjes" element={<ComercioCanjes />} />
                  ...
                  <ProtectedRoute>
                    <Layout>
                      <Routes>
                        ...
                        {/* Rutas info de audio */}
                        <Route path="/audio/dashboard" element={<AudioDashboardPage />} />
                        <Route path="/audio/segments" element={<AudioSegmentsPage />} />
                        <Route path="/audio/segments/:id" element={<AudioSegmentDetailPage />} />

                        {/* Rutas del bot */}
                        <Route path="/bot/product-meta" element={<BotProductMetaList />} />
                        <Route path="/bot/product-meta/nuevo" element={<BotProductMetaForm />} />
                        <Route path="/bot/product-meta/:id" element={<BotProductMetaForm />} />
                        <Route path="/bot/conversations" element={<BotConversationsPage />} />
                        <Route path="/bot/conversations/:id" element={<BotConversationDetailPage />} />
                        <Route path="/bot/branch-meta" element={<BotBranchMetaList />} />
                        <Route path="/bot/branch-meta/nuevo" element={<BotBranchMetaForm />} />
                        <Route path="/bot/branch-meta/:id" element={<BotBranchMetaForm />} />

                        <Route path="/bot/benefit-meta" element={<BotBenefitMetaList />} />
                        <Route path="/bot/benefit-meta/nuevo" element={<BotBenefitMetaForm />} />
                        <Route path="/bot/benefit-meta/:id" element={<BotBenefitMetaForm />} />

                        <Route path="/bot/event-meta" element={<BotEventMetaList />} />
                        <Route path="/bot/event-meta/nuevo" element={<BotEventMetaForm />} />
                        <Route path="/bot/event-meta/:id" element={<BotEventMetaForm />} />

                        <Route path="/fidelizacion/dashboard" element={<DashboardFidelizacion />} />
                        <Route path="/fidelizacion/comercios" element={<ComerciosAsociadosList />} />
                        <Route path="/fidelizacion/comercios/nuevo" element={<ComercioAsociadoForm />} />
                        <Route path="/fidelizacion/comercios/:id/editar" element={<ComercioAsociadoForm />} />
                        <Route path="/fidelizacion/comercios/:id/qr" element={<ComercioQrView />} />
                        <Route path="/fidelizacion/comercios/:id/puntos" element={<PuntosComercioView />} />

                        <Route path="/fidelizacion/campanias" element={<CampaniasList />} />
                        <Route path="/fidelizacion/campanias/nueva" element={<CampaniaForm />} />
                        <Route path="/fidelizacion/campanias/:id/editar" element={<CampaniaForm />} />

                        <Route path="/fidelizacion/premios-clientes" element={<PremiosClienteList />} />
                        ...
                        <Route path="/fidelizacion/premios-comercios" element={<PremiosComercioList />} />
                        <Route path="/fidelizacion/premios-comercios/nuevo" element={<PremioComercioForm />} />
                        <Route path="/fidelizacion/premios-comercios/:id/editar" element={<PremioComercioForm />} />

                        <Route path="/fidelizacion/canjes-comercios" element={<CanjesComerciosList />} />
                        <Route path="/fidelizacion/alertas-fraude" element={<AlertasFraudeList />} />
